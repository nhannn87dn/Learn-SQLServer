...
INSERT INTO Shippers (Id, ShipperName, Phone) VALUES
...
INSERT INTO Suppliers (Id, SupplierName, ContactName, Address, City, PostalCode, Country, Phone) VALUES
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO Customers (Id, CustomerName, ContactName, Address, City, PostalCode, Country) VALUES
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO Employees (Id, LastName, FirstName, BirthDate, Photo, Notes, NumberPhone, Email, Password) VALUES
...
(2, 'Fuller', 'Andrew', '1952-02-19', 'EmpID2.pic', 'Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas', '987654321', 'andrew@example.com', 'password456'),
...
(5, 'Buchanan', 'Steven', '1955-03-04', 'EmpID5.pic', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative ', '999999999', 'steven@example.com', 'passworddef'),
(6, 'Suyama', 'Michael', '1963-07-02', 'EmpID6.pic', 'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing).', '777777777', 'michael@example.com', 'passwordxyz'),
(7, 'King', 'Robert', '1960-05-29', 'EmpID7.pic', 'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company.', '222222222', 'robert@example.com', 'password1234'),
...
CREATE TABLE Products (
  ...
  CONSTRAINT fk_Orders_SupplierID FOREIGN KEY (SupplierID) 
        REFERENCES Suppliers(Id),
  CONSTRAINT fk_Orders_CategoryID FOREIGN KEY (CategoryID) 
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO Products (Id, ProductName, SupplierID, CategoryID, Unit, Price) VALUES
...
CREATE TABLE Orders (
  ...
  CONSTRAINT fk_Orders_OrderID FOREIGN KEY (CustomerID) 
        REFERENCES Customers(Id),
  CONSTRAINT fk_Orders_EmployeeID FOREIGN KEY (EmployeeID) 
        REFERENCES Employees(Id),
  CONSTRAINT fk_Orders_ShipperID FOREIGN KEY (ShipperID) 
...
CREATE TABLE Order_Details (
  ...
  CONSTRAINT fk_Order_Details_OrderID FOREIGN KEY (OrderID) 
        REFERENCES Orders(Id),
  CONSTRAINT fk_Order_Details_ProductID FOREIGN KEY (ProductID) 
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO Order_Details (Id, OrderID, ProductID, Quantity) VALUES
(1, 10248, 11, 12),
(2, 10248, 42, 10),
(3, 10248, 72, 5),
(4, 10249, 14, 9),
